...
class Menutop
{
	 ...
	 * @var string
	 *
	 * @ORM\Column(name="type", type="string", length=255, nullable = true, columnDefinition="ENUM('category','separator','url','column','city','type','event')")
	 */
	private $type = 'url';
	...
	/**
	 * @Gedmo\TreeParent
	 * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Menutop", inversedBy="children")
	 * @ORM\JoinColumn(name="parent_id", referencedColumnName="id", onDelete="CASCADE")
	 */
	private $parent;

	/**
	 * @ORM\OneToMany(targetEntity="AppBundle\Entity\Menutop", mappedBy="parent")
	 ...
	 * @ORM\JoinTable(name="menutop_to_domain",
	 ...
	 * @ORM\OneToOne(targetEntity="MenutopToRelatedProduct")
	...
	public function getRelatedProductEntity() {
	...
	public function getRelatedProduct()
	{
		if($this->related_product) {
			...
			if ($this->related_product->getHotel()) {
				return $this->related_product->getHotel();
			}
			return NULL;
		}
		return NULL;
